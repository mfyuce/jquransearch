...
public class KhodjaStemmer {
    ...
    private static void initComponents() {
        pathToStemmerFiles =  "stemming/khodja/StemmerFiles" + System.getProperty("file.separator");
        rootFound = false;
        stopwordFound = false;
        fromSuffixes = false;
    ...
    private static String checkForPrefixes(String word) throws IOException, URISyntaxException {
//        System.out.println("Enter checkForPrefix");
    ...
    private static boolean checkStopwords(String currentWord) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String isTwoLetters(String word) throws IOException, URISyntaxException {
    ...
    private static String isThreeLetters(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
...
//            possibleRoots[number][0] = stemmedDocument[wordNumber][0];
    ...
    private static void isFourLetters(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String checkPatterns(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String checkForSuffixes(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String duplicate(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String lastWeak(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String firstWeak(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String middleWeak(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    protected static boolean addVectorFromFile(String fileName) throws IOException, URISyntaxException {
        ...
        try {
            ...
            List<String> parts = loadResourceFile(fileName,KhodjaStemmer.class, Charset.forName("UTF-16"));
...
//            fileInputStream.close();
    ...
    // stem the word
    public String stemWord(String word) throws IOException, URISyntaxException {
        if (pathToStemmerFiles == null) {
            initComponents();
            staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
    ...
    private static String checkDefiniteArticle(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
    ...
    private static String checkPrefixWaw(String word) throws IOException, URISyntaxException {
        staticFiles = new Vector();
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "definite_article.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "duplicate.txt").toString()))
        if (addVectorFromFile(new StringBuffer(pathToStemmerFiles + "first_waw.txt").toString()))
